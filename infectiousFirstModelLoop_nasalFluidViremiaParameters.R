#Code to run the Infectious First model with parameters from viremia in nasal fluid from Beck-Johnson et al.for all herd sizes and seed sizes
...
parms2 <- c(beta=21.84, nu=(1/2.59), rho=(1/1.54), mu=(1/5.10))
  ...
  filenameC=paste("Var2nDDC",herdsize[h],"S",exposed[[h]][j],"csv",sep=".")
  filenameI=paste("Var2nDDI",herdsize[h],"S",exposed[[h]][j],"csv",sep=".")
...
parms2 <- c(beta=21.84, nu=(1/2.59), rho=(1/1.54), mu=(1/5.10))
  ...
  filenameC=paste("Var2nFDC",herdsize[h],"S",exposed[[h]][j],"csv",sep=".")
  filenameI=paste("Var2nFDI",herdsize[h],"S",exposed[[h]][j],"csv",sep=".")
