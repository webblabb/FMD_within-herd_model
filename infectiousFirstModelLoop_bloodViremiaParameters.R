...
parms2 <- c(beta=21.84, nu=(1/2.35), rho=(1/1.73), mu=(1/2.42))
  ...
  filenameC=paste("Var2bDDC",herdsize[h],"S",exposed[[h]][j],"csv",sep=".")
  filenameI=paste("Var2bDDI",herdsize[h],"S",exposed[[h]][j],"csv",sep=".")
...
parms2 <- c(beta=21.84, nu=(1/2.35), rho=(1/1.73), mu=(1/2.42))
  ...
  filenameC=paste("Var2bFDC",herdsize[h],"S",exposed[[h]][j],"csv",sep=".")
  filenameI=paste("Var2bFDI",herdsize[h],"S",exposed[[h]][j],"csv",sep=".")
